  ...
  return (
    <div className="sponsors">
      <div className="gold">
        ...
        <div
          className="ava-spon"
          style={{ backgroundImage: 'url(' + goldRank[indexGold].image + ')' }}
        ></div>
        ...
        <FontAwesomeIcon
          icon={faAngleDown}
          className="fa fa-angle-down control-sponsor"
          onClick={toDownGold}
        />
      </div>
      <div className="diamond">
        ...
        <div
          className="ava-spon"
          style={{
            backgroundImage: 'url(' + diamondRank[indexDiamond].image + ')',
          }}
        ></div>
      ...
      <div className="silver">
        ...
        <div
          className="ava-spon"
          style={{ backgroundImage: `url(${silverRank[indexSilver].image})` }}
        ></div>
