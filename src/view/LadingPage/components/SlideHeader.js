  ...
  return (
    <div className={classes} id="headers">
      ...
      <div className={respon}>
        <a href="#intros" onClick={() => clickBars()}>
          Introduce
        </a>
        <a href="#activities" onClick={() => clickBars()}>
          Activities
        </a>
        <a href="#members" onClick={() => clickBars()}>
          Members
        </a>
        <a href="#sponsors" onClick={() => clickBars()}>
          Sponsors
        </a>
        <a href="#companions" onClick={() => clickBars()}>
          Contributors
        </a>
