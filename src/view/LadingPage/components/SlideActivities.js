  ...
  return (
    <div className="activities">
      <div className="description">
        <h3>ACTIVITIES</h3>
        <p className="introActi">
          PROPTIT luôn tạo điều kiện để các bạn sinh viên có một môi trường học
          tập năng động, sáng tạo và cùng giúp đỡ nhau để có thành tích tốt
          trong học tập. PROPTIT luôn tổ chức các hoạt động thường niên để các
          thành viên trong CLB tham gia
        </p>
      </div>
      <div className="main">
        <h3>Cuộc thi</h3>
        ...
        <div className="img">
          <div className={classesCom}>
            <img
              src={competition[indexCompetition].image}
              alt="clb"
              style={{ width: '100%' }}
              // className={classes}
            />
        ...
        <FontAwesomeIcon
          ...
          className="control blur"
          onClick={() => toDownCompetition()}
        />
      </div>
      <div className="out">
        ...
        <div className="img">
          <div className={classesNK}>
            <img
              src={ngoaiKhoa[indexNgoaiKhoa].image}
              alt="clb"
              style={{ width: '100%' }}
            />
          </div>
