  ...
  return (
    <div className="edit-group">
      ...
      <div className="edit-info-group">
        {isAdmin ? <h5>Edit Information Group</h5> : <h5>Information Group</h5>}
        {isAdmin ? (
          <input
            type="text"
      ...
      <div className="edit-admins">
        {isAdmin ? <h5>Edit Admin</h5> : <h5>Admin</h5>}
        ...
        <div className="edit-admins__list">
          {group?.admins.map((admin) => {
            return (
              <div
                className="edit-admins__list-item"
                data-tip={admin.displayName}
                key={admin.id}
              >
      ...
      <div className="edit-members">
        {isAdmin ? <h5>Edit Members</h5> : <h5>Members</h5>}
