  ...
  useEffect(() => {
    if (group) {
      group.admins.forEach((item) => {
        if (item.id === user.id) setIsAdmin(true)
      })
    }
  }, [group])
    ...
    <div className="in-your-group__header">
      ...
      <div className="in-your-group__menu">
        <div className="in-your-group__menu-nav">
          <Link
            className={
              pathname === `/groups/${id}/about`
                ? 'in-your-group__menu-active'
                : ''
            }
            to={`/groups/${id}/about`}
          >
          ...
          <Link
            className={
              pathname === `/groups/${id}` ? 'in-your-group__menu-active' : ''
            }
            to={`/groups/${id}`}
          >
            Discussion
        ...
        <div className="in-your-group__menu-more">
          ...
          >
            <div className="menu-post-item">
              {isAdmin ? (
                <button className="btn" onClick={deleteThisGroup}>
                  Xoá
                </button>
              ) : (
                <div></div>
              ...
              <button className="btn" onClick={() => setShowMoreGroup(false)}>
                Cancel
              </button>
            </div>
          </Modal>
